                ...
                <form action="{{ route('clients.store') }}" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="origine_demande" id="status" class="form-select">
                                <option value="whatsapp" {{ old('origine_demande') == 'whatsapp' ? 'selected' : '' }}>WhatsApp</option>
                                <option value="mail" {{ old('origine_demande') == 'mail' ? 'selected' : '' }}>Mail</option>
                                <option value="direct" {{ old('origine_demande') == 'direct' ? 'selected' : '' }}>Direct</option>
                            </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3" mt-2>
                                ...
                                <select name="type_besoin" id="status" class="form-select">
                                    <option value="service" {{ old('type_besoin') == 'service' ? 'selected' : '' }}>Service</option>
                                    <option value="Marchandise" {{ old('type_besoin') == 'Marchandise' ? 'selected' : '' }}>Marchandise</option>
                                    <option value="Service_et_Marchandise" {{ old('type_besoin') == 'Service_et_Marchandise' ? 'selected' : '' }}>Service et Marchandise</option>
                        ...
                        <div class="col-md-6">
                            <label for="type_cadence" class="form-label">Précisez le Type de cadence</label>
                            <select name="type_cadence" id="status" class="form-select">
                                <option value="Ponctuelle" {{ old('type_cadence') == 'Ponctuelle' ? 'selected' : '' }}>Ponctuelle</option>
                                <option value="Reguliere" {{ old('type_cadence') == 'Reguliere' ? 'selected' : '' }}>Régulière</option>
                                <option value="Autre" {{ old('type_cadence') == 'Autre' ? 'selected' : '' }}>Autre</option>
                            </select>
                            @error('type_cadence')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="intervention" id="status" class="form-select">
                            <option value="non_confirmer" {{ old('intervention') == 'non_confirmer' ? 'selected' : '' }}>Non confirmée</option>
                            <option value="en_cour" {{ old('intervention') == 'en_cour' ? 'selected' : '' }}>En cours</option>
                            <option value="terminer" {{ old('intervention') == 'terminer' ? 'selected' : '' }}>Terminée</option>
                        </select>
                        @error('intervention')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea name="detail_service" id="name" class="form-control"
                                rows="4">{{ old('detail_service') }}</textarea>
        ...
        function toggleFields() {
            ...
            if (!autreBesoinInput) {
                ...
                newInput.innerHTML = `
                    ...
                    <input type="text" name="autre_besoin" class="form-control" />
                `;
            ...
            if (!autreCadenceInput) {
                ...
                newInput.innerHTML = `
                    ...
                    <input type="text" name="autre_type_cadence" class="form-control" />
                `;
